...
public class Music.Plugins.MtpConsoleProbe : GLib.Object {
    ...
    /* Attempt GetDevicePropValue for the useful device property codes. */
    private void dump_device_prop_values (unowned Mtp.Device device) {
        message ("--- Device property values (GetDevicePropValue) ---");

        /* Only the properties that are commonly present / useful. */
        uint16[] codes = {
