...
public class Music.MediaEditor : Granite.Dialog {
    ...
    private ActivatesDefaultEntry file_location_entry;
    ...
    construct {
        ...
        file_location_entry = new ActivatesDefaultEntry ();
        file_location_entry.expand = true;
        file_location_entry.editable = false;
        file_location_entry.can_focus = false;

        var edit_media_grid = new Gtk.Grid ();
        edit_media_grid.expand = true;
        edit_media_grid.margin_start = 12;
        edit_media_grid.margin_end = 12;
        edit_media_grid.column_spacing = 12;
        edit_media_grid.attach (new Granite.HeaderLabel (_("Title:")), 0, 0, 1, 1);
        edit_media_grid.attach (title_entry, 0, 1, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Artist:")), 1, 0, 1, 1);
        edit_media_grid.attach (artist_entry, 1, 1, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Album:")), 0, 2, 1, 1);
        edit_media_grid.attach (album_entry, 0, 3, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Album Artist:")), 1, 2, 1, 1);
        edit_media_grid.attach (album_artist_entry, 1, 3, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Composer:")), 0, 4, 1, 1);
        edit_media_grid.attach (composer_entry, 0, 5, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Grouping:")), 1, 4, 1, 1);
        edit_media_grid.attach (grouping_entry, 1, 5, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Genre:")), 0, 6, 1, 1);
        edit_media_grid.attach (genre_entry, 0, 7, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Year:")), 1, 6, 1, 1);
        edit_media_grid.attach (year_spinbutton, 1, 7, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Track:")), 1, 8, 1, 1);
        edit_media_grid.attach (track_spinbutton, 1, 9, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Disc:")), 1, 10, 1, 1);
        edit_media_grid.attach (disk_spinbutton, 1, 11, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Rating:")), 1, 12, 1, 1);
        edit_media_grid.attach (rating_widget, 1, 13, 1, 1);
        edit_media_grid.attach (new Granite.HeaderLabel (_("Comment:")), 0, 8, 1, 1);
        edit_media_grid.attach (comment_frame, 0, 9, 1, 5);

        var file_location_grid = new Gtk.Grid ();
        file_location_grid.expand = true;
        file_location_grid.margin_top = 12;
        file_location_grid.margin_start = 12;
        file_location_grid.margin_end = 12;
        file_location_grid.column_spacing = 12;
        file_location_grid.attach (new Granite.HeaderLabel (_("Location:")), 0, 0, 1, 1);
        file_location_grid.attach (file_location_entry, 0, 1, 1, 1);

        get_content_area ().add (edit_media_grid);
        get_content_area ().add (file_location_grid);
    ...
    private void set_media (Media m) {
        ...
        file_location_entry.text = current_media.get_display_location();
        var iterator = (Gee.BidirIterator<Media>) media_list.iterator_at (current_media);
